...
point1 = np.array([((r.random()*50)-25), ((r.random()*50)-25)])
point2 = np.array([((r.random()*50)-25), ((r.random()*50)-25)])
cornerP = np.array([((r.random()*50)-25), ((r.random()*50)-25)])
...
A = 
trans_curve = shp.transition_curve()
...
plt.plot([point1[0], cornerP[0], point2[0], ], [
         point1[1], cornerP[1], point2[1]], label="straigh_path")
